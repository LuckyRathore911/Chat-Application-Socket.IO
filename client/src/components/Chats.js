...
const Chats = ({ socket, userName, room }) => {
  ...
  const renderMessages = (messageData) => {
    if (messageData.type === "file") {
      const blob = new Blob([messageData.message], {
      ...
      return <Image fileName={messageData.fileName} blob={blob} />;
    }
  };
  ...
  return (
    <div className="chat-window">
                ...
                >
                  <div>
                    <div className="message-content">
                      <p>
                        if(messageContent.type =="file"){renderMessages()}else
      ...
      <div className="chat-footer">
        ...
        <button onClick={sendMessage} onSubmit="return false">
          &#9658;
        </button>
      </div>
    </div>
